...
<head>
    ...
    <style>
        ...
        .back-anim {
            /* animation: back-anim 44s ease infinite alternate; */
        ...
        <?php for ($i = 0; $i < $rtextAmt; $i++) {
            ...
            .txt_'.$i.' {
                ...
                top:     '.rand(35, 85).'vh;
                animation:
                    gen_anim_txt_'.rand(0, $rtextAmt-1).' '.rand(15, 60).'s
...
<body>
    <div class="body-wrap back-anim">
        ...
        ?>
        <a
            style="position: absolute; right: 3vw; bottom: 1vh; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: '.getRandColor().'"
            href="test.php">заряженная версия (жмяк)</a>
    </div>
<!-- . -->
</body>
</html>